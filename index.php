                ...
                <div class="container">
                    <div class = "row">	
                        <div class="col-md-12 py-2">
                            <h2 class="text-primary">Connected to <strong><?php echo str_replace("_", " ", DBNAME); ?></strong></h2>
                            <hr>
                        </div>
                        <div class="col-md-6">
                            <h3 id="fttl">Form </h3>
                ...
                if (!empty(protect($_GET['tbl'])) || !empty(protect($_GET['id']))) {
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="w-100 py-2">
                                <?php
                                echo '<h2><a href="index.php?view=list" class="btn btn-primary">Back to list</a> Edit ' . $titleTbl . '</h2>';
                                ?>
                            </div>
                            <div class="w-100">
                                <?php
                ...
                if (!empty(protect($_GET['tbl'])) || !empty(protect($_GET['id']))) {
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="w-100 py-2">
                                <?php
                                echo '<h2><a href="index.php?view=list" class="btn btn-primary">Back to list</a> Delete ' . $titleTbl . '</h2>';
                                ?>
                            </div>
                            <div class="w-100">
                                <?php
